...
export const TimerWidget = ({ location, onSessionEnd }: TimerWidgetProps) => {
  const { isTracking, sessionStart, currentSessionTime } = useTimerWidget()
            ...
            {isTracking && sessionStart ? (
              <div className="text-sm md:text-lg text-muted-foreground">
                ...
                <span className="font-semibold text-primary">
                  {sessionStart.toLocaleTimeString("en-US", { hour12: true, hour: "2-digit", minute: "2-digit" })}
                </span>
              </div>
            ) : (
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-xs md:text-sm text-muted-foreground mt-1">
                {isTracking ? "Elapsed Time" : "Session Time"}
              </div>
            </div>
